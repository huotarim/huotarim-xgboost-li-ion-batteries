...
## General info
This project includes algorithms and basic files XGBoost regression for predicting the state-of-health for litium-ion batteries.
This project does not include the proprieatary souce data (timeseries data) of the private data source.
	
## Setup
To download and examine the source code, please to the directory where you want to examine the code. 
Plase notice that this time it is not possible to install and run, due to the proprieatry data.
...
In more detail, the project is created with:
