# Implementation of linear regression model verification. Walk-forward sliding window for getting CI for RMSE 
#
...
def train_validation_split(data, timesteps, n):
    ...
    n_train_start = 0 # Expanding 0/ sliding n
...
for FILE in files:
    ...
    scores = repeat_evaluate(data, timesteps)

    # verify and get confidence intervals
    scores = repeat_evaluate(data, timesteps, n_repeats)

    # summarize scores
    summarize_scores(FILE, 'LR, expanding window', scores)
