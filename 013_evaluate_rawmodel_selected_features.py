...
# Select 5 final features
#names = ['BatteryStateOfCharge_Percent','BatteryVoltage_V','A_mean','min','Wh_sum',
# 'DSOC','DV','fD_all','fD_sel','cyc','TemperatureEnvironment_C','t-1', SOH']
